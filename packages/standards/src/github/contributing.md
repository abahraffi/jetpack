...
To get started, [file a GitHub issue](../issues/new). We would recommend relying on the default text that is pre-filled as you create a new issue; that text will help you create an issue that is easier to understand and reproduce by others who may join the conversation later on.
